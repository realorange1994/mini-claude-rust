...
pub fn build_child_config(parent_config: &Config, model_override: &str, max_turns: usize) -> Config {
    ...
    *child_config.permission_mode.lock().unwrap_or_else(|e| e.into_inner()) = crate::permissions::PermissionMode::Auto;
...
mod tests {
    ...
    fn test_build_child_config_auto_permission_mode() {
        ...
        assert_eq!(*child_config.permission_mode.lock().unwrap_or_else(|e| e.into_inner()), crate::permissions::PermissionMode::Auto);
    }
